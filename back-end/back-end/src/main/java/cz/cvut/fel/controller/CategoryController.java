...
public class CategoryController {
    ...
    @GetMapping(value = "/getBudget", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<?> getBudget(@RequestParam int budId) throws CategoryNotFoundException {
    ...
    @PostMapping(value = "/addTransactionToCategory", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<?> addTransactionToCategory(@RequestParam int transId, @RequestParam int categoryId) throws CategoryNotFoundException,
            TransactionNotFoundException {
        return new ResponseEntity<>(categoryService.addTransactionToCategory(transId, categoryId), HttpStatus.OK);
    }
