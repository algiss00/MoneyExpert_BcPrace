...
//            Cookie sessionCookie = cookieList.stream().filter(cookie -> SESSION_COOKIE_NAME
//                    .equals(cookie.getName())).findFirst().orElse(null);
//            if (sessionCookie != null) {
//                String contextPath = request.getServletContext() != null
//                        && StringUtils.isNotBlank(request.getServletContext()
//                        .getContextPath()) ? request.getServletContext().getContextPath() : ROOT_CONTEXT;
//                resp
//                        .setHeader(HttpHeaders.SET_COOKIE, sessionCookie.getName() + "="
//                                + sessionCookie.getValue() + SESSION_PATH_ATTRIBUTE + contextPath
