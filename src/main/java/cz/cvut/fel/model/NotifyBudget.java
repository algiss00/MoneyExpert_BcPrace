...
@NamedQueries({
        ...
        @NamedQuery(name = "NotifyBudget.getNotifyBudgetsFromBankAccountByType", query = "SELECT n FROM NotifyBudget n" +
                " where n.budget.bankAccount.id = :bankAccId and n.typeNotification = :typeNotif"),
